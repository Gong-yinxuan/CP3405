...
> **Auto-generated:** Generated from `Almanac Collector` output dated 2026-07-12T07:23:23Z. Review narrative sections before presenting.
...
| --- | --- | --- | --- |
| **Energy / XLE** | W09 current collector window | Bullish / positive current evidence | Energy is a leading sector at +3.49%, supporting a risk-on interpretation. |
| **Technology / XLK** | W09 current collector window | Bullish / positive current evidence | Technology is a leading sector at +2.87%, supporting a risk-on interpretation. |
| **Communication Services / XLC** | W09 current collector window | Bullish / positive current evidence | Communication Services is a leading sector at +1.86%, supporting a risk-on interpretation. |
| **Materials / XLB** | W09 current collector window | Bearish / weak current evidence | Materials is a lagging sector at -2.15%, so it should not be used as a leader. |
| **Healthcare / XLV** | W09 current collector window | Bearish / weak current evidence | Healthcare is a lagging sector at -1.77%, so it should not be used as a leader. |
| **Industrials / XLI** | W09 current collector window | Bearish / weak current evidence | Industrials is a lagging sector at -1.08%, so it should not be used as a leader. |
