...
| LLM synthesis | At least two LLMs are called via API, not only chat window. | To complete by R8 |
| LLM evidence | Raw API responses and comparison table are committed as files. | To complete by R8 |
