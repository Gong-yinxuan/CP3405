...
> **Auto-generated:** Generated from `Macro Collector` output dated 2026-07-10T07:28:20Z. Fields marked *Not automated* need to be filled in by hand -- see the script docstring for why.
...
## COMMODITIES & DOLLAR
- Crude Oil WTI: $71.60, Rising
- Gold: $4,121.50, Flat
- DXY: 100.79, Flat
- VIX: 15.84, Falling
- BTC: $63,917.10, Slightly Rising
...
Yields are rising on the week (avg +2.91%), with VIX at 15.8. Oil, gold, and dollar moves were weighed alongside these to produce a rough bearish lean (0 risk-on signal(s) vs 2 risk-off signal(s)). This draft does NOT reflect any Fed policy stance, scheduled data releases, earnings, or news events, since none of those are currently automated -- update this paragraph once those sections are filled in.
