...
> **Auto-generated:** Generated from `Almanac Collector` output dated 2026-07-12T06:41:15Z. Review narrative sections before presenting.
...
| --- | --- | --- | --- |
| **Energy / XLE** | W08 current collector window | Bullish / positive current evidence | Energy is a leading sector at +3.49%, supporting a risk-on interpretation. |
| **Technology / XLK** | W08 current collector window | Bullish / positive current evidence | Technology is a leading sector at +2.87%, supporting a risk-on interpretation. |
| **Communication Services / XLC** | W08 current collector window | Bullish / positive current evidence | Communication Services is a leading sector at +1.86%, supporting a risk-on interpretation. |
| **Materials / XLB** | W08 current collector window | Bearish / weak current evidence | Materials is a lagging sector at -2.15%, so it should not be used as a leader. |
| **Healthcare / XLV** | W08 current collector window | Bearish / weak current evidence | Healthcare is a lagging sector at -1.77%, so it should not be used as a leader. |
| **Industrials / XLI** | W08 current collector window | Bearish / weak current evidence | Industrials is a lagging sector at -1.08%, so it should not be used as a leader. |
