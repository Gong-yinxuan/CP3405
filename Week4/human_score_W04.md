...
- [ ] Read all AI outputs before scoring — not after
- [ ] All 5 dimensions scored independently as a team
- [ ] At least 1 dimension differs from AI consensus
- [ ] Specific written justification for any override or disagreement
- [ ] Final % range adjusted if Human Score points a different direction from AI
- [ ] Wild Card filled — something none of the four AIs raised
